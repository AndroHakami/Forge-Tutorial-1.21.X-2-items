...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.DAMAGE_BLOCK.get(),
                block -> createOreDrop(ModBlocks.DAMAGE_BLOCK.get(), ModItems.RAW_ALEXANDRITE.get()));
        this.add(ModBlocks.MAGIC_BLOCK.get(),
                block -> createMultipleOreDrops(ModBlocks.MAGIC_BLOCK.get(),Items.DANDELION, 2, 6));
